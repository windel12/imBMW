...
{
    public class EDC15C4AnalogValues : DDEAnalogValues
    {
        public EDC15C4AnalogValues() { }

        public EDC15C4AnalogValues(Message message)
        {
            Parse(message);
        }

        public EDC15C4AnalogValues(Message message, DateTime loggerStarted)
            : base(loggerStarted)
        {
            Parse(message);
        }
        ...
        {
            return message.SourceDevice == DeviceAddress.DDE
