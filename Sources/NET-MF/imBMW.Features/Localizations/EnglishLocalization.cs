...
namespace imBMW.Features.Localizations
{
    ...
    {
        public const string SystemName = "English";
        ...
        {
            get { return "Previous track"; }
        }

        public override string NextTrack
        {
            get { return "Next track"; }
        }
